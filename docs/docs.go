...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/ai/predict/men-body-scan": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Image file for body scanning",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "Body measurements predicted successfully",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
        ...
        "/ai/predict/skin-color-tone": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Image file for skin color tone analysis",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "Skin color tone predicted successfully",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dtos.BodyScanHistoryListDTO"
                                        }
                                    }
                                }
                            ]
        ...
        "/history/body/{id}": {
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Body Scan History ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dtos.FaceScanHistoryListDTO"
                                        }
                                    }
                                }
                            ]
        ...
        "/history/face/{id}": {
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Face Scan History ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dtos.SavedItemsDTO"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.AddProductItemToSavedItemsRequestDTO"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Product item added to savedItems successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.Response"
        ...
        "/savedItems/{itemId}": {
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "savedItems Item ID",
                        "name": "itemId",
                        "in": "path",
                        "required": true
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.UpdateProductItemInSavedItemsRequestDTO"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "savedItems item updated successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.Response"
                    ...
                    "404": {
                        "description": "savedItems item not found",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "savedItems item removed successfully",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
                    "400": {
                        "description": "Invalid savedItems item ID",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    },
        ...
        "/track/click/product/{id}": {
            "get": {
                ...
                "responses": {
                    "302": {
                        "description": "Redirect to brand store"
                    },
                    "404": {
                        "description": "Product not found",
                        "schema": {
    ...
    "definitions": {
        ...
        "dtos.AddProductItemToSavedItemsRequestDTO": {
            "type": "object",
            "required": [
                "product_item_id",
                "quantity"
        ...
        "dtos.BodyScanHistoryDTO": {
            ...
            "properties": {
                ...
                "image_url": {
                    "description": "Signed URL from Supabase",
                    "type": "string"
                },
                "scan_name": {
                    "type": "string"
        ...
        "dtos.BodyScanHistoryListDTO": {
            "type": "object",
            "properties": {
                "histories": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.BodyScanHistoryDTO"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "dtos.FaceScanHistoryListDTO": {
            "type": "object",
            "properties": {
                "histories": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.FaceScanHistoryDTO"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "dtos.SavedItemsDTO": {
            ...
            "properties": {
                ...
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.SavedItemDTO"
                    }
                },
                "updated_at": {
                    "type": "string"
        ...
        "dtos.UpdateProductItemInSavedItemsRequestDTO": {
            "type": "object",
            "required": [
                "quantity"
            ],
